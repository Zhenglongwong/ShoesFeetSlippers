...
const Navbar = () => {
	...
	const logout = async () => {
		...
		if (data.status !== 200) {
			...
			dispatchCart({ type: "CLEAR", payload: {} as ICartItem });
			navigate("/");
		}
	};
	...
	return (
		<header className="bg-gray-900">
				...
				<div className="flex items-center justify-between h-16">
					...
					<div className="flex items-center gap-4">
						...
						<div className="block md:hidden">
							<button className="p-2 text-white bg-gray-800 rounded hover:text-white/75">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									className="w-5 h-5"
									fill="none"
			...
			<CartModal open={cartModal} setModal={setCartModal} />
		</header>
	);
};
